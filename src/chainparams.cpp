...
#define GENESIS_IMAGE       ""
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyDecreaseInterval = 1050000;                 // 每1050000个区块减产一次(约10年)
        consensus.nSubsidyReductionTimes = 24;                        // 一共经过24次减产
        consensus.blockSubsidyPow = 25 * COIN;                        // 初始奖励25 MTL
        consensus.nMinSubsidy = 1 * COIN;                             // 最小奖励1 MTL, 减到1个后停止减少
        consensus.blockSubsidyHive = 1 * COIN;                        // Hive挖矿奖励
        consensus.blockSubsidyPopPrivate = 0.2 * COIN;               // 私有POP奖励
        consensus.blockSubsidyPopPublic = 0.05 * COIN;               // 公共POP奖励
        ...
        consensus.nMinMTLAmount = 0.01 * COIN;             // MTL最小单位0.01枚


        // Ring-fork: Hive: Consensus Fields
        consensus.dwarfCost = 0.01 * COIN;                  // Cost of a dwarf
        consensus.dwarfCreationAddress = "MTLSummonADwarvenMiningArmyXYzDNsz";  // Unspendable address for dwarf creation
        consensus.hiveCommunityAddress = "MTLBEERnxAdgdRfSa45NFy5bZfQPYbztkn";  // Community fund address
...
public:
    CTestNetParams() {
        ...
        // Ring-fork: Hive: Consensus Fields
        consensus.dwarfCost = 0.01 * COIN;                  // Cost of a dwarf
        consensus.dwarfCreationAddress = "TMTLSummonTheDwarvenArmyXaNdvvm";  // Unspendable address for dwarf creation
        consensus.hiveCommunityAddress = "TMTL4fmbrApQcUhDd2RtVsRVts7ptizk39C9";  // Community fund address
        consensus.communityContribFactor = 5;               // Optionally, donate dct_value/maxCommunityContribFactor to community fund
        consensus.dwarfGestationBlocks = 720;               // The number of blocks for a new dwarf to mature (approx 24 hours)
        consensus.dwarfLifespanBlocks = 30000;              // The number of blocks a dwarf lives for after maturation (approx 10 days)
        consensus.powLimitHive = uint256S("0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");  // Highest// Highest (easiest) dwarf hash target
        consensus.minHiveCheckBlock = consensus.lastInitialDistributionHeight + 1;   // Don't bother checking below this height for Hive blocks (not used for consensus/validation checks, just efficiency when looking for potential DCTs)
        consensus.hiveBlockSpacingTarget = 2;               // Target Hive block frequency (1 out of this many Hive and pow blocks combined should be Hivemined)
        consensus.hiveBlockSpacingTargetTypical = 2;        // Observed Hive block frequency (1 out of this many Hive and pow blocks combined are observed to be Hive)
        consensus.hiveNonceMarker = 1;                      // Nonce marker for hivemined blocks
